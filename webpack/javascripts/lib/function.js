...
!function(e) {
    ...
    SEMICOLON.initialize = {
        ...
        goToTopScroll: function() {
            ...
            return i || (i = 450),
                "true" != e && (a.hasClass("device-xs") || a.hasClass("device-xxs")) ? !0 : void (t.scrollTop() > Number(i) ? W.fadeIn() : W.fadeOut())
        },
        fullScreen: function() {
        ...
        SEMICOLON.header = {
            ...
            superfish: function() {
                return (a.hasClass("device-lg") || a.hasClass("device-md")) && (e("#primary-menu ul ul, #primary-menu ul .mega-menu-content").css("display", "block"),
                    ...
                    e().superfish ? (e("body:not(.side-header) #primary-menu > ul, body:not(.side-header) #primary-menu > div > ul:not(.dropdown-menu), .top-links > ul").superfish({
            ...
            sidePanel: function() {
                e(".side-panel-trigger").click(function() {
                    ...
                    a.hasClass("device-touch") && a.hasClass("side-push-panel") && a.toggleClass("ohidden"),
                        !1
                })
            },
                    ...
                    s || (s = "easeOutQuad"),
                        x.find("a[data-href]").click(function() {
                            ...
                            if (e(o).length > 0) {
                                ...
                                (768 > l || a.hasClass("overlay-menu")) && (e("#primary-menu").find("ul.mobile-primary-menu").length > 0 ? e("#primary-menu > ul.mobile-primary-menu, #primary-menu > div > ul.mobile-primary-menu").toggleClass("show", !1) : e("#primary-menu > ul, #primary-menu > div > ul").toggleClass("show", !1),
        ...
        SEMICOLON.widget = {
            ...
            parallax: function() {
                return e.stellar ? void ((J.length > 0 || X.length > 0 || K.length > 0) && (SEMICOLON.isMobile.any() ? (J.addClass("mobile-parallax"),
...
jQuery(document).ready(function(t) {
    ...
    i.attr("href", "sticky-sidebar.php"),
        i.find("div").html('Sticky Sidebar <div class="label bgcolor nott" style="position: relative; top: -1px; margin-left: 5px;">New</div>')
});
